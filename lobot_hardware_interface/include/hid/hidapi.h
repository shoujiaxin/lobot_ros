...
*/
size_t HID_API_EXPORT HID_API_CALL hid_read_timeout(hid_device *dev,
                                                    unsigned char *data,
                                                    size_t length,
                                                    int milliseconds);
...
*/
size_t HID_API_EXPORT HID_API_CALL hid_read(hid_device *device,
...
/** @brief Send a Feature report to the device.
        ...
        @returns
                ...
                -1 on error.
*/
size_t HID_API_EXPORT HID_API_CALL hid_send_feature_report(
